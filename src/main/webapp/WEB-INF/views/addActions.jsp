    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">Add Actions</h1>
                <p class="mb-4">Please select actions here</p>
                        ...
                        <div class="table-responsive">
                            <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"><div class="dataTables_length" id="dataTable_length">
                                ...
                                <tr role="row"  >
                                    ...
                                    <th class="sorting_asc" tabindex="1" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 100px;">Name</th>
                                </tr>
                                <c:forEach items="${actions}" var="action">
                                    <tr>
                                        <td style="width: 50px;"><input type="checkbox" name="actions" value="${action}"></td>
                                        <td>${action}</td>
                                    </tr>
                                </c:forEach>
                                ...
                                <div class="col-sm-12 col-md-5"><div class="dataTables_info" id="dataTable_info" role="status" aria-live="polite">    <input type="submit" value="Submit" />
