    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <p class="mb-4">
                    Here you can view all orders</p>

                <!-- DataTales Example -->

                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">APUD</h6>
                    </div>
                            ...
                            <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"><div class="dataTables_length" id="dataTable_length">
                                ...
                                <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width:750px">
                                    ...
                                    <tr role="row"  >
                                        ...
                                        <th tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 10px;">ID</th>
                                        <th class="sorting_asc" tabindex="1" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 100px;">numberDMS</th>
                                        <th class="sorting_asc" tabindex="1" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 100px;">numberFV</th>
                                        <th class="sorting_asc" tabindex="1" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 100px;">Car</th>
                                        <th class="sorting_asc" tabindex="1" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 100px;">Actions</th>
                                    </tr>
                                    <c:forEach items="${zlecList}" var="item">
                                        <tr>
                                            <td>${item.id}</td>
...
<table border="1">
    ...
    <c:forEach var="item" items="${zlecList}">
        <tr>
            <td>${item.id}</td>
            <td>${item.numberDMS}</td>
            <td>${item.numberFV}</td>
