            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Services List & Info</h6>
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Create Services</h1>
                            </div>
                            ...
                            <form:form method="post" modelAttribute="serwis">
                                ...
                                <div class="form-group">
                                    <form:input id="name" name="name"  placeholder="Name" type="text" class="form-control" value="" path="name"/>
                                    <form:errors path="name" element="name"></form:errors>
                                </div>

                                <div class="form-group">
                                    <form:input id="street" name="street"  placeholder="Street" type="text" class="form-control" value="" path="street"/>
                                    <form:errors path="street" element="street"></form:errors>
                                </div>
                                <div class="form-group">
                                    <form:input id="city" name="city"  placeholder="City" type="text" class="form-control" value="" path="city"/>
                                    <form:errors path="city" element="city"></form:errors>

                                </div>
                                <div class="form-group">
                                    <form:input id="postcode" name="postcode"  placeholder="Postcode" type="text" class="form-control" value="" path="postcode"/>
                                    <form:errors path="postcode" element="postcode"></form:errors>
