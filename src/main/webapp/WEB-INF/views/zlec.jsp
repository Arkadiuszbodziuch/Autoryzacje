                        ...
                        <div class="p-5">
                            ...
                            <form:form method="post" modelAttribute="zlec" >
                                <div>
                                            ...
                                            <form:input  placeholder="Order Number" path="numberDMS" id="numberDMS" type="text"/>
                                            <form:errors path="numberDMS" element="div"></form:errors>
                                </div>
                                <div>
                                            <br><br>
                                            <input  placeholder="Registration Number" type="text" name="string">

                                </div>
                                <br>

                                <input style="margin-top: 10px" value="submit" type="submit" class="btn btn btn-primary btn-block" value="Submit"></input>
                                        </form:form>
