                    ...
                    <div class="card-header py-3">
                        ...
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Create Car</h1>
                            </div>
<form:form method="post" modelAttribute="car">
                            ...
                            <div class="form-group">
                                <form:input id="registrationNumber" name="registrationNumber"  placeholder="Registration Number" type="text" class="form-control" value="" path="registrationNumber"/>
                                <form:errors path="registrationNumber" element="registrationNumber"></form:errors>
                            </div>

                            <div class="form-group">
                                <form:input id="vin" name="vin"  placeholder="VIN" type="text" class="form-control" value="" path="vin"/>
                                <form:errors path="vin" element="vin"></form:errors>
                            </div>
                            <div class="form-group">
                                <form:input id="brand" name="brand"  placeholder="Brand" type="text" class="form-control" value="" path="brand"/>
                                <form:errors path="brand" element="brand"></form:errors>

                            </div>
                            <div class="form-group">
                                <form:input id="model" name="model"  placeholder="Model" type="text" class="form-control" value="" path="model"/>
                                <form:errors path="model" element="model"></form:errors>

                            </div>
                            <div class="form-group">
                                <form:input id="course" name="course"  placeholder="Course" type="number" class="form-control" value="" path="course"/>
                                <form:errors path="course" element="course"></form:errors>

                            </div>

                            <div class="form-group">
                                <form:input id="nip" name="nip"  placeholder="NIP" type="number" class="form-control" value="" path="nip"/>
                                <form:errors path="nip" element="nip"></form:errors>

                            </div>
                            <input style="margin-top: 10px" value="submit" type="submit" class="btn btn btn-primary btn-block"></input>
